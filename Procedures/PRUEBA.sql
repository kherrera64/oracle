  ...
  select a.CARRERA,D.ENCARGADO, 
           ...
           --obtengo los ingresos desglosados que corresponden a los creditos
               ...
               NVL(DBAFISICC.EDOCTA.RINGRESOSTIPOPAGO2(:PFECHAINI,:PFECHAFIN,'R', 
                                                'EFECTIVO', null, a.CARRERA),0) 
                                                REFECTIVO,  
               NVL(DBAFISICC.EDOCTA.RINGRESOSTIPOPAGO2(:PFECHAINI,:PFECHAFIN,'R', 
                                                'CHEQUE', 'BI', a.CARRERA),0) 
                                                RCHEQUESBI,  
               NVL(DBAFISICC.EDOCTA.RINGRESOSTIPOPAGO2(:PFECHAINI,:PFECHAFIN,'R', 
                                                'CHEQUE', null, a.CARRERA),0) 
                                                RCHEQUESOT, 
               NVL(DBAFISICC.EDOCTA.RINGRESOSTIPOPAGO2(:PFECHAINI,:PFECHAFIN,'R', 
                                                'TARJETA', null, a.CARRERA),0) 
                                                RTARJETAS, 
               NVL(DBAFISICC.EDOCTA.RINGRESOSTIPOPAGO2(:PFECHAINI,:PFECHAFIN,'R', 
                                                'BIENLINEA', null, a.CARRERA),0) 
                                                RMQSERIESAG,
               NVL(DBAFISICC.EDOCTA.RINGRESOSTIPOPAGO2(:PFECHAINI,:PFECHAFIN,'R', 
                                                'BIENLINEA', 'INTERNET', 
                                                a.CARRERA) ,0) RMQSeriesIN
